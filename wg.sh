...
echo -e "${Info} Wireguard VPS AutoScript by mohd adam"
...
# Tambahan
cd /usr/bin
wget -O add-wg "https://raw.githubusercontent.com/scriptadamcrew/Nakata2/main/add-wg.sh"
wget -O del-wg "https://raw.githubusercontent.com/scriptadamcrew/Nakata2/main/del-wg.sh"
wget -O cek-wg "https://raw.githubusercontent.com/scriptadamcrew/Nakata2/main/cek-wg.sh"
wget -O renew-wg "https://raw.githubusercontent.com/scriptadamcrew/Nakata2/main/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
