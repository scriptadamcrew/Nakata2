#!/bin/bash
#shadowsocks-libev obfs install by Nakata
...
cd /usr/bin
wget -O add-ss "https://raw.githubusercontent.com/scriptadamcrew/Nakata2/main/add-ss.sh"
wget -O del-ss "https://raw.githubusercontent.com/scriptadamcrew/Nakata2/main/del-ss.sh"
wget -O cek-ss "https://raw.githubusercontent.com/scriptadamcrew/Nakata2/main/cek-ss.sh"
wget -O renew-ss "https://raw.githubusercontent.com/scriptadamcrew/Nakata2/main/renew-ss.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
chmod +x renew-ss
